...
Документ описывает, как сообщать о багах, предлагать улучшения и оформлять
pull request'ы так, чтобы изменения попали в релиз без лишних итераций.
...
просьбой дополнить. Без данных баг неотличим от misconfiguration.
